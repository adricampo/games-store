...
export function crearNuevoProductoAction(producto) {
    return async (dispatch) => {
        ...
        try {
            ...
            //si va bien, actualiza el state del producto
...
// 2) Descarga productos de la base de datos
...
// si los productos llegan correctamente
const descargaProductosExito = productos => ({
    type: DESCARGA_PRODUCTOS_EXITO,
    payload: productos
})

// si los productos no llegan correctamente (ERROR)
...
// 3) Seleccionar y eliminar un producto
...
// 5) Editar un registro en la API y el state
